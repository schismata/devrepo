...
def CATEGORIES():
        addDir2('[COLOR lime]>>> Search Movies <<<[/COLOR]','http://moviehdmax.com/',3,icon,fanart)
        addDir2('[COLOR red]>>> Search TV <<<[/COLOR]','http://moviehdmax.com/',30,icon,fanart)
        addDir2('[COLOR gold](IMDB) Popular Movies[/COLOR]','https://www.themoviedb.org/movie?page=1',35,icon8,fanart)
        addDir2('[COLOR gold](IMDB) Top Rated[/COLOR]','https://www.themoviedb.org/movie/top-rated?page=1',35,icon8,fanart)
        addDir2('[COLOR gold](IMDB) Now Playing[/COLOR]','https://www.themoviedb.org/movie/now-playing?page=1',35,icon8,fanart)
        addDir2('[COLOR lime]AFDAH-XMOVIES8[/COLOR]','http://moviehdmax.com/',37,icon5,fanart)
		
        addDir2('[COLOR yellow]MOVIEHDMAX[/COLOR]','http://moviehdmax.com/',5,icon5,fanart)
        addDir2('[COLOR aqua]XMOVIES8[/COLOR]','http://xmovies8.tv/cinema-movies/page/1',24,icon7,fanart)
        addDir2('[COLOR orange]FREE FULL MOVIES[/COLOR]','http://www.freefullmovies.net/mp4',6,icon2,fanart)
        addDir2('[COLOR green]ONLINEMOVIES.IS[/COLOR]','http://onlinemovies.is/',20,icon6,fanart)
...
def MOVIEHDMAX():
        ...
        addDir2('Others','http://moviehdmax.com/search/genre/others?page=1#genre',1,icon5,fanart)
def AFDAH():
