...
addon_id = 'plugin.video.itastreaming'
...
def CATEGORIES():
        ...
        addDir2('[COLOR white]Ultime Uscite[/COLOR]','http://itastreaming.co/nuove-uscite/page/1/',1,icon,fanart)
        
        addDir2('[COLOR white]Generi[/COLOR]','http://www.cb01.co/category/hd-alta-definizione/',5,icon2,fanart)

	addDir2('Cerca Film','http://www.cb01.co/',3,icon3,fanart)
	
def GENRES():
        
        addDir2('Animazione','http://itastreaming.co/genere/animazione/page/1/',1,icon2,fanart)
        addDir2('Avventura','http://itastreaming.co/genere/avventura/page/1/',1,icon2,fanart)
        addDir2('Azione','http://itastreaming.co/genere/azione/page/1/',1,icon2,fanart)
        addDir2('Comico','http://itastreaming.co/genere/comico/page/1/',1,icon2,fanart)
        addDir2('Commedia','http://itastreaming.co/genere/commedia/page/1/',1,icon2,fanart)
        addDir2('Drammatico','http://itastreaming.co/genere/drammatico/page/1/',1,icon2,fanart)
        addDir2('Fantascienza','http://itastreaming.co/genere/fantascienza/page/1/',1,icon2,fanart)
        addDir2('Fantasy','http://itastreaming.co/genere/fantasy/page/1/',1,icon2,fanart)
       
        addDir2('Guerra','http://itastreaming.co/genere/guerra/page/1/',1,icon2,fanart)
        addDir2('Horror','http://itastreaming.co/genere/horror/page/1/',1,icon2,fanart)
        
        addDir2('Romantico','http://itastreaming.co/genere/romantico/page/1/',1,icon2,fanart)
        addDir2('Storico','http://itastreaming.co/genere/storico/page/1/',1,icon2,fanart)
        addDir2('Thriller','http://itastreaming.co/genere/thriller/page/1/',1,icon2,fanart)
        addDir2('Giallo','http://itastreaming.co/genere/giallo/page/1/',1,icon2,fanart)
...
def GETLINKSNEW(url,name,iconimage):
        ...
        match=re.compile('<iframe width=".+?" height=".+?" src="(.+?)" allowfullscreen').findall(link)
...
def SEARCH():
    ...
    if len(search_entered)>1:
     try:
    	url = 'http://www.itastreaming.co/?s=' + search_entered
        GETSEARCH(url,name)
     except: pass
