...
def GENRES():
        ...
        addDir2('Adventure','https://xmovies8.org/adventure_movies?page=1',2,icon,fanart)
        addDir2('Sci-Fi','https://xmovies8.org/sci-fi_movies?page=1',2,icon,fanart)
        addDir2('Thriller','https://xmovies8.org/thriller_movies?page=1',2,icon,fanart)
        addDir2('Documentary','https://xmovies8.org/documentary_movies?page=1',2,icon,fanart)
        addDir2('Family','https://xmovies8.org/family_movies?page=1',2,icon,fanart)
        addDir2('History','https://xmovies8.org/history_movies?page=1',2,icon,fanart)
        addDir2('Crime','https://xmovies8.org/crime_movies?page=1',2,icon,fanart)
        addDir2('Drama','https://xmovies8.org/drama_movies?page=1',2,icon,fanart)
        addDir2('Fantasy','https://xmovies8.org/fantasy_movies?page=1',2,icon,fanart)
        addDir2('Horror','https://xmovies8.org/horror_movies?page=1',2,icon,fanart)
        addDir2('Music','https://xmovies8.org/music_movies?page=1',2,icon,fanart)
        addDir2('Mystery','https://xmovies8.org/mystery_movies?page=1',2,icon,fanart)
        addDir2('Romance','https://xmovies8.org/romance_movies?page=1',2,icon,fanart)
        addDir2('War','https://xmovies8.org/war_movies?page=1',2,icon,fanart)
        addDir2('Western','https://xmovies8.org/western_movies?page=1',2,icon,fanart)
