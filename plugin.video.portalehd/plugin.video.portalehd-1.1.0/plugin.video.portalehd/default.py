...
def GETLINK(url,name):
        ...
        link = open_url(url)
        if 'category/serials/' in url: metaset='false'
        match=re.compile('<script type="text/javascript" src="http://videomega.tv/(.+?)">').findall(link)
        ...
        for url in match:
                        ...
                        name=re.sub('SubITA','', name)
                        name=re.sub('-','', name)
                        url="http://videomega.tv/" + url
                        addLink('Play >>>',url,11,icon,'',fanart)
...
elif mode==5: GETMOVIESWATCHFILMD(url,name)
elif mode==6: GETITALIAFIM(url,name)
elif mode==7: GETITALIAFILMTV(url,name)
elif mode==8: GETITALIAFILMEPISODES(url,name)
elif mode==2: GETTV(url,name)
elif mode==3: SEARCHMOVIES()
elif mode==4: SEARCHTV()
elif mode==9: GETLASTEPISODE(url,name)
...
elif mode==101: PLAYLINKWATCHFILMHD(name,url,iconimage)
elif mode==102: PLAYITALIAHDFILM(name,url,iconimage)
elif mode==103: PLAYEPISODE(name,url,iconimage)
